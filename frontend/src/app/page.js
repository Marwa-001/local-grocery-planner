      ...
      <div className="max-w-xl mx-auto px-6 py-12">
        ...
        <header className="mb-12">
          ...
          <p className="text-slate-500 text-lg leading-relaxed">
            Your personal market companion, synced securely to your account.
          </p>
        </header>

        {!user ? (
          <div className="bg-white p-8 rounded-[2rem] border border-slate-100 shadow-sm text-center">
            <p className="text-slate-500 mb-6">Log in to see your lists, catalog, and favorites.</p>
            <Link
              href="/login"
              className="inline-block bg-slate-900 hover:bg-indigo-600 text-white px-8 py-4 rounded-2xl font-bold transition-all shadow-xl shadow-slate-200 active:scale-95"
            >
              Log In
            </Link>
          </div>
        ...
        <footer className="mt-20 text-center">
          <p className="text-slate-300 text-xs font-medium">
            Your data is securely stored on your account.<br />
            Log in from any device to pick up where you left off.
          </p>
        </footer>
      </div>
    </div>
